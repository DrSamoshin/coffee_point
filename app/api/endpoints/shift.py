...
async def update_shift_start(shift_id: UUID, db: Session = Depends(get_db), user_id: str = Depends(get_user_id_from_token)):
    return crud_shift.update_start_shift(db, shift_id)
