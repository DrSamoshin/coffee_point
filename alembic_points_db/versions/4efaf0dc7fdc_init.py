...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "time_point",
            sa.Enum("start_shift", "end_shift", name="checklisttimepoint"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "position",
            sa.Enum("barista", "manager", name="employeeposition"),
            nullable=False,
        ),
        sa.Column("deactivated", sa.Boolean(), nullable=True),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_index(
        op.f("ix_reporting_periods_id"), "reporting_periods", ["id"], unique=False
    )
    op.create_table(
        "shifts",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_employee_shifts_id"), "employee_shifts", ["id"], unique=False
    )
    op.create_table(
        "orders",
        sa.Column("id", sa.UUID(), nullable=False),
        ...
        sa.Column(
            "payment_method",
            sa.Enum("cash", "card", name="orderpaymentmethod"),
            nullable=False,
        ),
        sa.Column(
            "type",
            sa.Enum("dine_in", "delivery", "takeaway", name="ordertype"),
            nullable=False,
        ),
        sa.Column("date", sa.DateTime(), nullable=False),
        sa.Column(
            "status",
            sa.Enum("waiting", "completed", "cancelled", name="orderstatus"),
            nullable=False,
        ),
        sa.Column("shift_id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_product_orders_id"), "product_orders", ["id"], unique=False
    )
    op.create_table(
        "recipe_items",
        sa.Column("id", sa.UUID(), nullable=False),
